 ...
 */
public class NewMessageNotification455 {
    /**
    ...
    public static void notify(final Context context,
       ...
       /* PendingIntent contentIntent = PendingIntent.getActivity(context, number,
        ...
        CharSequence name = "BootChannle2";// The user-visible name of the channel.
        ...
        builder .setDefaults(Notification.DEFAULT_VIBRATE)
              ...
              //  .setSound(Uri.parse("android.resource://"+context.getPackageName()+"/" + R.raw.tone455));
