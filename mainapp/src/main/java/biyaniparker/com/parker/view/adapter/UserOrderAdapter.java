...
public class UserOrderAdapter extends ArrayAdapter
{
    ...
    public UserOrderAdapter(Context context, int resource, ArrayList<OrderMasterBean> objects)
    {
    ...
    class ViewHolder
    {
        TextView txtOrNo, txtTAmt, txtOrDate, txtTQnty, txtOStatus;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView==null)
        {
            ...
            convertView=inflater.inflate(R.layout.o_item_user_orderlist,null);
