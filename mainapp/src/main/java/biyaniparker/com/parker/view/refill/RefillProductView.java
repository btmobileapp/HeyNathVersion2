...
public class RefillProductView extends AppCompatActivity implements View.OnClickListener , DownloadUtility{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent=new Intent(RefillProductView.this,ViewProductImage.class);
        ...
        getSupportActionBar().setTitle("Product Refill");
    ...
    public void onClick(View v)
    {
        ...
        else
        {
                ...
                else
                {
                    try
                    {
                        moduleProduct.refillProduct(bean, stockList);
                    }
